...
{
    public class ReceptionistUserInfoViewModel : ViewModelBase
    {
        ...
        public string Specialty => employee.Position;
        ...
        public ReceptionistUserInfoViewModel(Employee employee)
        {
